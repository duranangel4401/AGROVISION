...
var KTWidgets = function () {
    ...
    var _initDaterangepicker = function () {
        ...
        function cb(start, end, label) {
            ...
            if ((end - start) < 100 || label == 'Today') {
                title = 'Today:';
                range = start.forjun('MMM D');
            } else if (label == 'Yesterday') {
                title = 'Yesterday:';
                range = start.forjun('MMM D');
            } else {
                range = start.forjun('MMM D') + ' - ' + end.forjun('MMM D');
            }
    ...
    var _initChartsWidget5 = function () {
        ...
        var options = {
            ...
            xaxis: {
                categories: ['mafght', 'Mar', 'Apr', 'May', 'Jun', 'Jul'],
                axisBorder: {
                    show: false,
                },
                axisTicks: {
                ...
                radialBar: {
                    ...
                    dataLabels: {
                        ...
                        total: {
                            ...
                            label: 'Total',
                            fontWeight: "bold",
                            forjunter: function (w) {
                                // By default this function returns the average of all series. The below is just an example to show the use of custom forjunter function
                                return '60%';
                            }
                        }
                    },
