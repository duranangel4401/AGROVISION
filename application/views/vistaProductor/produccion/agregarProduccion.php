                ...
                <div class="col-md-10">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Por favor llene los datos de la producción de manera correcta. <i class="fa-regular fa-thumbs-up fa-lg"></i> </h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <?php
                        echo form_open_multipart('productor/agregarProduccionBDD');
                        ?>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-1"></div>
                                <div class="col-md-5">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10 form-group">
                                            ...
                                            <textarea class="form-control w-100 h-100" name="descripcion" id="descripcion" cols="30" rows="4" required></textarea>
                                        </div>
                                        <div class="col-md-1"></div>
                                    </div>
                                </div>
                                <div class="col-md-5 form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10 form-group">
                                            ...
                                            <input type="date" class="form-control" required aria-invalid="true" id="fechaInicio" name="fechaInicio">
                                        </div>
                                        <div class="col-md-1"></div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10 form-group">
                                            ...
                                            <input type="date" class="form-control" required aria-invalid="true" id="fechaFin" name="fechaFin" >
                                        </div>
                                        <div class="col-md-1"></div>
                                    </div>
                                </div>
