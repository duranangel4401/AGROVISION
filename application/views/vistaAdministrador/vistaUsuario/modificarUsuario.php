<div class="content-wrapper" style="background-image: url('<?php echo base_url(); ?>adminlte/images/fondo.jpg'); background-size: cover;">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><strong>INICIO - AGROVISION 2023</strong></h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-md-3">
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <a href="<?php echo base_url() ?>index.php/administrador/index">
                            ...
                            <button type="reset" class="btn btn-danger btn-block"><i class="fa-solid fa-user-large-slash fa-lg"></i>  <b>Cancelar Modificación de Datos</b></button>
                        </a>
                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="active tab-pane" id="activity">
                                    <div class="row">
                                        <div class="col-md-9">
                                            <h4><strong>Modificar datos Usuario</strong></h4>
                                        </div>
                                        <div class="col-md-3">
                                        </div>
                                    </div>
                                    ...
                                    foreach ($datosUsuario->result() as $row) {
                                        echo form_open_multipart('usuarios/modificarUsuarioBDD');
                                    ?>

                                        <div class="form-group row">
                                            <label for="inputName" class="col-sm-2 col-form-label">Nombre Completo:</label>
                                            <div class="col-sm-3">
                                                <input type="hidden" value="<?php echo $row->id ?>" id="idUsuario" name="idUsuario">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-2">
                                                <input type="number" value="<?php echo $row->telefono ?>" class="form-control" id="telefonos" name="telefonos" required aria-invalid="true" placeholder="Introduce Telefono/Celular">
                                            </div>
                                            <div class="col-sm-3">
